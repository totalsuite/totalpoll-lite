...
<div class="totalpoll-settings-item">
    <div class="totalpoll-settings-field">
        <label class="totalpoll-settings-field-label">
			<?php _e( 'Timeout', 'totalpoll' ); ?>
            <span class="totalpoll-feature-details" tooltip="<?php _e( 'The time period before the user can vote again.', 'totalpoll' ); ?>">?</span>
        </label>
        <div class="totalpoll-settings-timeout">
            ...
            <label class="totalpoll-settings-timeout-value">
                <input type="radio" name="frequencyTimeout" ng-checked="editor.isCustomTimeout()" ng-click="!editor.isCustomTimeout() && editor.setTimeout(1)"/><?php echo _e('Custom (minutes)', 'totalpoll'); ?>
            </label>
        </div>
        <input type="number" min="0" step="1" class="totalpoll-settings-field-input widefat"
