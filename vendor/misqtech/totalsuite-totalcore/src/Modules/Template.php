...
use TotalPollVendors\TotalCore\Helpers\Compressor;
...
abstract class Template extends Module {
	...
	public function getCompiledCss( $args = [] ) {
		if ( ! \TotalPollVendors\TotalCore\Application::get( 'filesystem' )->is_readable( $this->getPath( 'assets/css/style.css' ) ) ):
			return null;
		endif;
