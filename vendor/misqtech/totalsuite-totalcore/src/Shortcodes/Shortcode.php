...
namespace TotalPollVendors\TotalCore\Shortcodes;

use TotalPollVendors\TotalCore\Contracts\Shortcodes\Shortcode as ShortcodeContract;

/**
 * Shortcodes base class
 * @package TotalPollVendors\TotalCore\Shortcodes
 * @since   1.0.0
 */
