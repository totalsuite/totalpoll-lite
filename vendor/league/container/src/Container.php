...
use TotalPollVendors\League\Container\Argument\RawArgumentInterface;
use TotalPollVendors\League\Container\Definition\DefinitionFactory;
use TotalPollVendors\League\Container\Definition\DefinitionFactoryInterface;
use TotalPollVendors\League\Container\Definition\DefinitionInterface;
use TotalPollVendors\League\Container\Exception\NotFoundException;
use TotalPollVendors\League\Container\Inflector\InflectorAggregate;
use TotalPollVendors\League\Container\Inflector\InflectorAggregateInterface;
use TotalPollVendors\League\Container\ServiceProvider\ServiceProviderAggregate;
use TotalPollVendors\League\Container\ServiceProvider\ServiceProviderAggregateInterface;

class Container implements ContainerInterface
{
    /**
     * @var \TotalPollVendors\League\Container\Definition\DefinitionFactoryInterface
     */
    protected $definitionFactory;

    /**
     * @var \TotalPollVendors\League\Container\Definition\DefinitionInterface[]
     */
    ...
    /**
     * @var \TotalPollVendors\League\Container\Inflector\InflectorAggregateInterface
     */
    protected $inflectors;

    /**
     * @var \TotalPollVendors\League\Container\ServiceProvider\ServiceProviderAggregateInterface
     */
    protected $providers;
     ...
     * Constructor.
     *
     * @param \TotalPollVendors\League\Container\ServiceProvider\ServiceProviderAggregateInterface|null $providers
     * @param \TotalPollVendors\League\Container\Inflector\InflectorAggregateInterface|null             $inflectors
     * @param \TotalPollVendors\League\Container\Definition\DefinitionFactoryInterface|null             $definitionFactory
     */
