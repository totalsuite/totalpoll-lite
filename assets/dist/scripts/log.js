...
(function (TotalPoll) {
    ...
    var Entry = /** @class */ (function (_super) {
        ...
        function Entry(attrs) {
            ...
            var details = angular.copy(_this.get('details', {}));
            delete details.skipped;
            _this.set('flattenDetails', _this.flatten(details));
            return _this;
        }
        ...
        Entry.prototype.getDetails = function () {
            return this.get('flattenDetails', {});
        };
        Entry.prototype.getEntry = function () {
            return this.get('entry');
        };
        Entry.prototype.getIP = function () {
            return this.get('ip');
        };
        Entry.prototype.getPollEditLink = function () {
            return this.get('poll.admin.editLink');
        };
        Entry.prototype.getPollTitle = function () {
            return this.get('poll.title');
        };
        Entry.prototype.getStatus = function () {
            return this.get('status');
        };
        Entry.prototype.getUTCDate = function () {
            return this.get('date').substring(0, 10) + " @ " + this.get('date').substring(11, 16);
        };
...
(function (TotalPoll) {
    ...
    var LogBrowserComponent = /** @class */ (function (_super) {
        ...
        function LogBrowserComponent($scope, RepositoryService, $location) {
        ...
        LogBrowserComponent.prototype.hasPreviousItem = function () {
            if (this.currentItem) {
        ...
        LogBrowserComponent.prototype.isModalOpen = function () {
        ...
        LogBrowserComponent.prototype.nextItem = function () {
            if (this.hasNextItem()) {
        ...
        LogBrowserComponent.prototype.openItem = function (item) {
            this.currentItem = item;
            this.currentItemIndex = this.items.indexOf(item);
        };
        LogBrowserComponent.prototype.previousItem = function () {
...
(function (TotalPoll) {
    ...
    TotalPoll.log = angular
        ...
        .value('pollId', window['TotalPollLog']['pollId'] || null);
})(TotalPoll || (TotalPoll = {}));
