...
(function (TotalPoll) {
    ...
    var Entry = /** @class */ (function (_super) {
        ...
        Entry.prototype.getField = function (fieldName) {
            var value = this.get("fields." + fieldName, this.get(fieldName));
    ...
    TotalPoll.Entry = Entry;
})(TotalPoll || (TotalPoll = {}));
var TotalPoll;
(function (TotalPoll) {
    var Service = TotalCore.Common.Service;
    var RepositoryService = /** @class */ (function () {
        function RepositoryService($resource, $httpParamSerializerJQLike, prefix, ajaxEndpoint, pollId) {
            this.$httpParamSerializerJQLike = $httpParamSerializerJQLike;
            this.prefix = prefix;
            this.ajaxEndpoint = ajaxEndpoint;
            this.pollId = pollId;
            this.resource = $resource(ajaxEndpoint, {}, {
                list: { method: 'GET', cache: true, params: { poll: pollId } },
        ...
        RepositoryService.prototype.getDownload = function (format, filters) {
            ...
            var query = this.$httpParamSerializerJQLike(angular.extend({}, { action: this.prefix + "_entries_download", poll: this.pollId, format: format }, filters));
        ...
        RepositoryService.prototype.getPage = function (page, filters) {
            ...
            return this.resource
                .list(angular.extend({}, { action: this.prefix + "_entries_list", page: page }, filters))
                .$promise
                .then(function (response) {
                response['entries'] = response['entries'].map(function (entry) {
                    return new TotalPoll.Entry(entry);
                });
                return response;
            });
        };
        RepositoryService.prototype.getPolls = function () {
            return this.resource
                .polls({ action: 'totalpoll_entries_polls' })
                .$promise;
        };
...
(function (TotalPoll) {
    ...
    var EntriesBrowserComponent = /** @class */ (function (_super) {
        __extends(EntriesBrowserComponent, _super);
        function EntriesBrowserComponent(RepositoryService, $location) {
            ...
            _this.currentPage = Math.abs(Number(urlParams['currentPage']) || 1);
            _this.filters.poll = Number(urlParams['poll']) || null;
            _this.filters.from = urlParams['from'] || null;
            _this.filters.to = urlParams['to'] || null;
            return _this;
        }
        EntriesBrowserComponent.prototype.$onInit = function () {
            this.loadPolls();
            if (this.filters.poll) {
                this.loadPage(this.currentPage);
            }
        };
        EntriesBrowserComponent.prototype.canExport = function () {
            return this.entries.length > 0;
        };
        EntriesBrowserComponent.prototype.exportAs = function (format) {
            this.RepositoryService.getDownload(format, this.filters);
        };
        EntriesBrowserComponent.prototype.getFields = function () {
            if (this.filters.poll) {
                for (var _i = 0, _a = this.polls; _i < _a.length; _i++) {
                    var poll = _a[_i];
                    if (poll.id == this.filters.poll) {
                        return poll.fields;
                    }
                }
            }
        ...
        EntriesBrowserComponent.prototype.hasNextPage = function () {
            return !this.lastPage;
        };
        EntriesBrowserComponent.prototype.hasPreviousPage = function () {
            return this.currentPage != 1;
        };
        EntriesBrowserComponent.prototype.isFirstPage = function () {
            return this.currentPage === 1;
        };
        EntriesBrowserComponent.prototype.isLastPage = function () {
            return this.lastPage;
        };
        EntriesBrowserComponent.prototype.isPage = function (page) {
            return this.currentPage == page;
        };
        EntriesBrowserComponent.prototype.isProcessing = function () {
            return this.processing;
        };
        EntriesBrowserComponent.prototype.loadPage = function (page) {
            var _this = this;
            if (!this.filters.poll) {
                this.updateUrl();
                this.entries = [];
        ...
        EntriesBrowserComponent.prototype.loadPolls = function () {
            var _this = this;
            this.processing = true;
            this.RepositoryService
                .getPolls()
        ...
        EntriesBrowserComponent.prototype.nextPage = function () {
            this.loadPage(this.currentPage + 1);
        };
        EntriesBrowserComponent.prototype.previousPage = function () {
            this.loadPage(this.currentPage - 1);
        };
        EntriesBrowserComponent.prototype.resetFilters = function () {
            this.filters.from = null;
            this.filters.to = null;
            this.loadPage(1);
        };
        EntriesBrowserComponent.prototype.updateUrl = function () {
            this.$location.search(angular.extend({}, this.$location.search(), this.filters, { currentPage: this.currentPage }));
        };
        EntriesBrowserComponent = __decorate([
            Component('components.totalpoll', {
                templateUrl: 'entries-browser-component-template',
                bindings: {}
            })
        ], EntriesBrowserComponent);
        return EntriesBrowserComponent;
    }(Processable));
})(TotalPoll || (TotalPoll = {}));
...
(function (TotalPoll) {
    ...
    TotalPoll.entries = angular
        ...
        .value('pollId', window['TotalPollEntries']['pollId'] || null);
})(TotalPoll || (TotalPoll = {}));

//# sourceMappingURL=maps/entries.js.map
